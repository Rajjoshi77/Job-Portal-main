...
export default function JobDetails() {
    ...
    const handleContact = () => {
        if (!user) return toast.error('Please Login First');
        router.push(`/frontend/ContactJob/${id}`)
    }
                                    ...
                                    <div className='flex items-center justify-center'>
                                        {
                                            JobDetails?.user?.email === user?.email ? (
                                                ...
                                                <div className='flex items-center justify-center  '>
                                                    ...
                                                    <button onClick={handleContact} className='md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 ml-2 bg-indigo-500 rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-indigo-900 text-white  '>Contact</button>
                                                </div>
                                            )
                                        }
                                    </div>
