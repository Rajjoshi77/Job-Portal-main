        ...
        <>
            <div className={`w-full ${scrolled ? "bg-indigo-600/70" : "bg-indigo-600"} px-6 h-20 bg-indigo-600 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
                ...
                <div className='px-2 h-full hidden items-center justify-center lg:flex'>
                    ...
                    <Link href={'/frontend/ManageJob'} className="px-3 mx-4 text-base font-medium transition-all duration-700 hover:translate-y-2 uppercase" >Manage Job</Link>

                    <Link href={'/frontend/ManageUser'} className="px-3 mx-4 text-base font-medium transition-all duration-700 hover:translate-y-2 uppercase" >Manage User</Link>
